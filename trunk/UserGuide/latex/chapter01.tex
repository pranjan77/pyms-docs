...
\begin{verbatim}
$ tar Pycluster-1.41.tar.gz
$ cd Pycluster-1.41
$ python setup.py install
\end{verbatim}

\noindent
After the above is completed, open {\tt
/usr/local/lib/python2.5/site-packages/Pycluster/\_\_init\_\_.py} and
replace all occurences of 'Numeric' with 'numpy'.
...
\noindent
Since ndimage was installed outside the scipy, this requires some manual
correction steps:
