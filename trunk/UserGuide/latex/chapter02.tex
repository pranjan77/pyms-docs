...
\section{Example 3a: Loading Xcalibur peak list or creating an experiment from Xcalibur data}
...
\section{Example 3b: AMDIS Peak Parser}
...
\noindent
\begin{itemize}
\item [ {\em This example is in pyms-test/05} ]
...
\section{Example 7: Noise smoothing in ion chromatograms}
